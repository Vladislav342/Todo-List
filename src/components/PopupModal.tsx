import { labelsForPopupModal } from '@/constants';
          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <h3 className="text-lg leading-6 font-medium text-gray-900">
                {add
                  ? labelsForPopupModal.creatingLabel
                  : labelsForPopupModal.deletingLabel}
              </h3>
              <div className="mt-2">
                <p className="text-sm leading-5 text-gray-500">
                  {add
                    ? labelsForPopupModal.creatingMsg
                    : labelsForPopupModal.deletingMsg}
                </p>
              </div>
            </div>
          </div>
